...
EBTNodeResult::Type UUGRC_BTT_RotateToFaceTarget::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
...
void UUGRC_BTT_RotateToFaceTarget::TickTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
	FRotateToFaceTargetTaskMemory* Memory = CastInstanceNodeMemory<FRotateToFaceTargetTaskMemory>(NodeMemory);
...
bool UUGRC_BTT_RotateToFaceTarget::HasReachedAnglePrecision(TObjectPtr<APawn> QueryPawn,
